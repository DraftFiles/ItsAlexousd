...
<head>
	...
	<title>Demander un devis | Développeur Java & Youtubeur de 1000 abonnés</title>
...
<section id="path">
	<div class="content">
	<p><a href="/">ItsAlexousd.fr</a> > <span>Social</span> > <span>Devis</span></p>
	<a href="/contact">Envoyer un mail</a>
	</div>
</section>
...
if(isset($_POST['message'])) { 
    ...
    $email_project  = $_POST['project'];        // PROJET DEL'AUTEUR
    ...
    $mail->Body    = '<html>
                        <body>
                            <table style="width:100%;">
                                ...
                                <tr>
                                    <td colspan="2">Projet : ' . nl2br( $_POST['projet'] ) . '</td>
                                </tr><br>
                                <tr>
...
?>
		<form method="POST" name="form" enctype="multipart/form-data">
            ...
            <input maxlength="50" name="author" type="text" placeholder="Pseudo" required/>

            <input maxlength="50" name="email" type="email" placeholder="Adresse mail" required/>

            <input type="text" maxlength="50" name="discord" placeholder="Pseudo discord"/>

            <input maxlength="50" name="project" type="text" placeholder="Nom du projet"/>
